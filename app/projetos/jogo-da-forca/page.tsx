...
const WORDS = [
    "DIVA", "LACREI", "LACRACAO", "ICONE", "PERFEITA", "MARAVILHOSA", "SERVIU", "ENTREGOU", "TUDO", "PATROA", "DEUSA", "RAINHA", "GATISSIMA", "ARRASOU", "FECHOU", "BABADO", "GRITANDO", "SURTEI", "PASSADA", "CHOCADA", "AMADA", "QUERIDA", "MONA", "MIGA", "AMIGA", "BESTIE", "GATA", "VIADA", "SAPATAO", "BISEXUAL", "ORGULHO", "BRILHO", "PODEROSA", "ICONICA", "PLENA", "ESTRANHA", "DEBOCHADA", "VENENOSA", "FIQUEI", "MORTA", "REAGI", "HUMILHOU", "CANCELADA", "FAVORITA", "HITOU", "TOMBADA", "MILF", "BLOGUEIRA", "INFLUENCER"
];
